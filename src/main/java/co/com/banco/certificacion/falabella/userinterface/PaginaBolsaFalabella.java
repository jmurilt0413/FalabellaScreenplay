...
public final class PaginaBolsaFalabella {
  ...
  public static final Target BTN_IR_COMPRA = Target.the("Boton ir compra")
      .locatedBy("//div[@class='fb-order-status__cta']");

  public static final Target LISTA_COBERTURAS_SEGURO = Target.the("lista de coberturas a asegurar")
      .locatedBy(
